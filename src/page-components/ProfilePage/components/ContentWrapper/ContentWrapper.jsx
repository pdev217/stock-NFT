...
export const ContentWrapper = () => {
  ...
  useEffect(() => {
    choosenSection === "activity" && activitiesAdapter();
  }, [choosenSection]);
              ...
              <div className={styles.rightBottomSide}>
                ...
                {choosenSection === "activity" && tokens && tokens.length > 0 && (
                  <div className={styles.activitiesWrapper}>
                    ...
                    {activities.length > 0 &&
                      activities.map(({ buyer, seller, id, nft, action, quantity, date }) => (
                          ...
                          <div className={cn(styles.activityRowPriceWrapper, styles.priceColumn)}>
                            {nft.price ? (
                              <>
                                ...
                                <div className={styles.activityRowUsdPrice}>${nft.price.usd}</div>
                              </>
                            ) : (
                              <span>———</span>
                            )}
