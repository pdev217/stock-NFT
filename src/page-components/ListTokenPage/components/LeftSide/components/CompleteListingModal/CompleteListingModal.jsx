                  ...
                  {currencies.length > 0 && (
                    <>
                      <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                        ...
                        />
                        <span style={{ fontWeight: '600', fontSize: '18px', textAlign: 'right' }}>{price}</span>
                      </span>
                      {usdPrice && (
                        <span style={{ marginTop: '4px', fontSize: '16px', textAlign: 'right' }}>${usdPrice}</span>
                      )}
                    </>
                  )}
                </div>
          ...
          >
            ...
            <div style={{ padding: '16px' }}>
              <span style={{ color: 'var(--light-grey)', fontSize: '14px' }}>
                To get up for selling on Stoke for the first time, you must initialize your wallet, which requires a one
                - time gas fee
              </span>
            </div>
            <div
            ...
            >
              ...
              >
                <div
                  style={{
                    border: `2px solid ${
                      activeStep === 'approve' || activeStep === 'confirm' ? 'var(--primary)' : 'var(--light-grey)'
                    }`,
                    alignItems: 'center',
                    borderRadius: '50%',
                    display: 'flex',
